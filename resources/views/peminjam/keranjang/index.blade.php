...
<head>
    ...
    <title>Keranjang — Perpustakaan SDN Pasireurih</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* nav-item sebagai button */
        button.nav-item {
            background: transparent; border: none; width: calc(100% - 20px);
            cursor: pointer; font-family: 'Sora', sans-serif;
        }
        button.nav-item:hover { background: rgba(255,255,255,.1) !important; color: #fff !important; }
        button.nav-item:focus, button.nav-item:active { outline: none; box-shadow: none; }
        ...
        .btn-koleksi {
            ...
            background: #0f1f5c; color: #fff;
            border-radius: 9px; padding: 8px 16px;
            font-family: 'Sora', sans-serif;
            font-size: 13px; font-weight: 700;
            text-decoration: none; transition: all .2s;
            box-shadow: 0 4px 14px rgba(15,31,92,.25);
        }
        .btn-koleksi:hover { background: #1a2e6f; color: #fff; text-decoration: none; transform: translateY(-1px); }
...
<div id="page-loader">
    <div class="pl-book">
        ...
        <span class="pl-book-ring"></span>
        <i class="fas fa-shopping-cart pl-book-icon"></i>
    </div>
    <div class="pl-brand">
    ...
    <span class="pl-text">Memuat keranjang peminjaman...</span>
</div>
...
<aside class="sidebar">
    <a href="{{ route('landing') }}" class="sidebar-brand">
        ...
        <div class="brand-texts">
            <span class="b-name">Perpustakaa</span>
    ...
    <nav class="sidebar-nav">
        ...
        @endphp
        <a href="/keranjang" class="nav-item active">
...
<div class="main-wrapper">
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            <a href="{{ route('koleksi.buku') }}" class="btn-koleksi">
                <i class="fas fa-book-open"></i> Koleksi Buku
            </a>
    ...
    <footer class="page-footer">
        &copy; {{ date('Y') }} <strong>Perpustakaan SDN Pasireurih</strong>. All rights reserved.
    </footer>
